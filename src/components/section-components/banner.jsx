			            ...
			            <div className="row">
			              <div className="col-lg-9 col-sm-8">
			                <div className="banner-inner">
			                  ...
			                  <h2 className="banner-title s-animate-2">Đà Nẵng <br /> City</h2>
			                </div>
			              </div>
			              <div className="col-lg-3 col-sm-4">
			                <div className="video-popup-btn s-animate-video">
			                  <a href="https://www.youtube.com/watch?v=zGF4U1qIYSc" className="video-play-btn mfp-iframe"><i className="fa fa-play" /></a>
			                </div>
			              </div>
			                ...
			                <div className="row">
			                  ...
			                  <div className="col-sm-4 s-animate-5">
			                    <div className="tp-price-meta">
			                      <p>Date</p>
			                      <h2>20</h2>
			                      <p className="tp-price-meta-details">Nov <span>or later</span></p>
			                    </div>
			                  </div>
			                </div>
			              </div>
			          ...
			          <div className="col-xl-8 col-lg-9 offset-xl-2 offset-lg-1">
			            <div className="row">
			              <div className="col-lg-9 col-sm-8">
			                <div className="banner-inner">
			                  <p className="banner-cat s-animate-1">Hot Places</p>
			                  <h2 className="banner-title s-animate-2">Hồ Chí Minh <br /> City</h2>
			                </div>
			              </div>
			              <div className="col-lg-3 col-sm-4">
			                <div className="video-popup-btn s-animate-video">
			          ...
			          <div className="col-xl-8 col-lg-9 offset-xl-2 offset-lg-1">
			            <div className="row">
			              <div className="col-lg-9 col-sm-8">
			                <div className="banner-inner">
			                  <p className="banner-cat s-animate-1">Hot Places</p>
			                  <h2 className="banner-title s-animate-2">Phú Quốc <br /> Island</h2>
			                </div>
			              </div>
			              <div className="col-lg-3 col-sm-4">
			                <div className="video-popup-btn s-animate-video">

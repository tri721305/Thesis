     ...
     render() {
          return (
               <div
                    ...
                    style={{ backgroundImage: "url(" + "../../../public/assets/img/bg/8.png)" }}
               >
                    <div className="container">
                              ...
                              <div className="col-xl-6 col-lg-9">
                                   <div className="section-title text-center">
                                        ...
                                        <p className="wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s">
                                             Goz cung cấp cho người dùng các Kế hoạch ( Plan ) nỗi bật mà các thành viên cũng như người dùng
                                             Goz trải nghiệm và dành thời gian chia sẽ.{" "}
                                        </p>
                                   </div>
                              </div>
                         </div>
                         <div className="row">
                                   ...
                                   >
                                        ...
                                        <div className="details">
                                             <p className="location">
                                                  <img src={"../../../public/assets/img/icons/1.png"} alt="map" />
                                                  VietNam
                                             </p>
                                             <h4 className="title">
                              ...
                              <div className="col-lg-3 col-sm-6">
                                   ...
                                   >
                                        <div className="thumb">
                                             <img src={"../../../public/assets/img/destination-list/5.png"} alt="list" />
                                        </div>
                                        <div className="details">
                                             <p className="location">
                                                  <img src={"../../../public/assets/img/icons/1.png"} alt="map" />
                              ...
                              <div className="col-lg-3 col-sm-6">
                                   ...
                                   >
                                        <div className="thumb">
                                             <img src={"../../../public/assets/img/destination-list/6.png"} alt="list" />
                                        </div>
                                        <div className="details">
                                             <p className="location">
                                                  <img src={"../../../public/assets/img/icons/1.png"} alt="map" />
                              ...
                              <div className="col-lg-3 col-sm-6">
                                   ...
                                   >
                                        <div className="thumb">
                                             <img src={"../../../public/assets/img/destination-list/7.png"} alt="list" />
                                        </div>
                                        <div className="details">
                                             <p className="location">
                                                  <img src={"../../../public/assets/img/icons/1.png"} alt="map" />

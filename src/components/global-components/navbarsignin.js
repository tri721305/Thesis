            ...
            <nav className="navbar navbar-area navbar-expand-lg nav-style-01 viaje-go-top">
			  <div className="container nav-container">
			      ...
			      <div className="nav-right-content">
			        <ul className="pl-0">
			          <li className="top-bar-btn-booking">
			            <Link className="btn btn-yellow" to="/tour-details">Sign In <i className="fa fa-paper-plane" /></Link>
			          </li>
			    ...
			    <div className="collapse navbar-collapse" id="tp_main_menu">
			      <div className="logo-wrapper desktop-logo">
			        <Link to="/" className="main-logo">
			          <img src={publicUrl+"assets/img/logo.png"} alt="logo" style={{height: "50px"}}/>
					</Link>
			      ...
			      <ul className="navbar-nav">
			        ...
			        <li className="menu-item-has-children">
			          ...
			          <ul className="sub-menu">
			            ...
			            <li><Link to="/tour-list-v2">Tours List</Link></li>
			    ...
			    <div className="nav-right-content">
			      <ul>
			        <li>
			          <Link className="btn btn-yellow" to="/tour-details">Register <i className="fa fa-arrow-right" /></Link>
			        </li>
			        <li className="tp-lang">
			          <div className="tp-lang-wrap">
			            <select className="select single-select">

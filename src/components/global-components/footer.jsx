               ...
               <footer className="footer-area" style={{ backgroundImage: "url(" + publicUrl + "assets/img/bg/2.png)" }}>
                              ...
                              <div className="col-lg-4 col-md-6">
                                   <div className="footer-widget widget">
                                        <div className="about_us_widget">
                                             ...
                                             <p>Trải nghiệm của người dùng tạo nên Goz.</p>
                                             <ul className="social-icon">
                                                  ...
                                                  <li>
                                                       <a className="twitter" href="https://twitter.com/codingeeknet" target="_blank">
                                   ...
                                   <div className="footer-widget widget ">
                                        <div className="widget-contact">
                                             ...
                                             <p>
                                                  ...
                                                  <span>Đại học Bách Khoa, TPHCM</span>
                                             </p>
                    ...
                    <div className="copyright-inner">
                         <div className="copyright-text">
                              © Goz 2020 All rights reserved. Powered with by{" "}
